-- Messaging and Connection System Database Schema - FIXED VERSION
-- This script creates the necessary tables for alumni messaging and connections
-- Handles existing tables and data type conflicts
...
-- 2. MESSAGES TABLE - Store all messages between alumni (using BIGSERIAL for compatibility)
