...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      {/* Top Banner - Logo and Auth Buttons */}
      <div className="navbar-top">
        <div className="container">
          <div className="navbar-brand">
            <Link to="/" className="navbar-logo">
              <img src="/assets/UIC(3).png" alt="UIC Logo" className="logo-image" />
              <span className="logo-text">UNIVERSITY OF THE IMMACULATE CONCEPTION</span>
            </Link>
          </div>
      ...
      {/* Bottom Banner - Navigation Links */}
